...
msg_attributes db '(', 0x0A, '2', 0x01, '5', 0x02, ',', 0x03, ' ', 0x04, '1', 0x05, '0', 0x06, ')', 0x07, ' ', 0x08, 'A', 0x09, 'n', 0x0A, 'd', 0x0B, 'r', 0x0C, 'i', 0x0D, 'e', 0x0E, 's', 0x0F, ' ', 0x01, 'A', 0x02, 'l', 0x03, 'e', 0x04, 'x', 0x05, 'a', 0x06, 'n', 0x07, 'd', 0x08, 'r', 0x09, 'u', 0x0A
